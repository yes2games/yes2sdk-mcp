...
export const SDK_META: Record<Engine, EngineMeta> = {
  "unity": {
    ...
    "installSteps": [
      ...
      "Enter: https://github.com/yes2games/yes2sdk-unity.git#v2.4.3  (the #v2.4.3 tag pins this release; drop the tag only to track main).",
  ...
  "defold": {
    ...
    "installSteps": [
      ...
      "Under the [project] section add a dependency:  dependencies#0 = https://github.com/yes2games/yes2sdk-defold/archive/refs/tags/v1.4.0.zip  (use the tagged release archive, not a branch URL — GitHub serves release archives more reliably).",
